...
namespace NHibernate.Test.TypesTest
{
	...
	[TestFixture]
	[Obsolete]
	public class DateTime2TypeFixture : AbstractDateTimeTypeFixture<DateTime2Type>
	{
	...
	[TestFixture]
	[Obsolete]
	public class DateTime2TypeWithScaleFixture : AbstractDateTimeTypeFixture<DateTime2Type>
	{
		protected override bool AppliesTo(Dialect.Dialect dialect) =>
			TestDialect.SupportsSqlType(SqlTypeFactory.DateTime2);
